...
namespace AS
{
    public class CameraHandler : MonoBehaviour
    {
        ...
        public bool disableCameraRotation;
        ...
        public void HandleCameraRotation(float delta, float mouseXInput, float mouseYInput)
        {
            ...
            Vector3 dir = currentLockOnTarget.lockOnTransform.position - transform.position; 
            dir.Normalize();
            dir.y = 0;
            ...
            dir = currentLockOnTarget.lockOnTransform.position - cameraPivotTransform.position;
            dir.Normalize();
        ...
        {
            disableCameraRotation = !isEnabled;
        }
